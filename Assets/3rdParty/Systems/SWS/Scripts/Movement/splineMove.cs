...
namespace SWS
{
    ...
    public class splineMove : MonoBehaviour
    {
        ...
        public UnityAction<int> OnReachReception;
        ...
        /// <summary>
        public void SetPath(PathManager newPath, bool isPlay = true)
        {
